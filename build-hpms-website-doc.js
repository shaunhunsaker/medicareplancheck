...
const SMID = "MULTIPLAN_MPCWeb26LP1_M  (displayed in site footer)";
...
const doc = new Document({
  ...
  sections: [{
    ...
    children: [
      ...
      h1("6. Confirmation / Thank-You Page (Post-Submission)"),
      p("After a visitor completes and submits the lead form, they are redirected to the confirmation page at https://www.medicareplancheck.org/thank-you. This page is part of the lead-generation flow — it confirms the submission, restates the free click-to-call option, and sets expectations for the licensed-agent callback.", { after: 120 }),
      new Paragraph({ spacing: { after: 80 }, children: [new ImageRun({ type: "png", data: fs.readFileSync(path.join(DIR, "thank-you-shot.png")), transformation: { width: 320, height: 413 }, altText: { title: "Confirmation / thank-you page", description: "MedicarePlanCheck.org /thank-you", name: "thank-you-shot.png" } })] }),
      p("Live capture of https://www.medicareplancheck.org/thank-you.", { italics: true, size: 18, after: 120 }),
      h2("Thank-You Page Copy (Verbatim)"),
      p("Logo: MedicarePlanCheck"),
      p("Headline: “You’re all set! A licensed agent will call you shortly.”"),
      p("Subtitle: “We’re reviewing plans available in your area. Most people hear back within minutes during business hours.”"),
      p("Call nudge: “Don’t want to wait? Talk to an agent right now — it’s free.”  →  Call 1-877-339-1956.  Sub-line: “Mon–Fri 6:30am–4pm PT · No hold music · Real licensed agents.”"),
      p("What happens next: (1) “We match your ZIP code to Medicare Advantage plans available in your area.”  (2) “A licensed agent calls you to walk through what extra benefits could be included — dental, vision, OTC allowances and more.”  (3) “Zero obligation. The review is completely free. Enroll only if a plan is a better fit for you.”"),
      p("Disclaimer (verbatim, foot of page):", { bold: true, after: 80 }),
      quote("Not affiliated with Medicare or the U.S. government. Benefits vary by plan and location. Licensed insurance agents. Not available in all areas."),
      p("Conversion tracking: Meta Pixel “Lead” event and StackAdapt conversion fire on page load, confirming the form submission.", { italics: true, size: 18 }),

      h1("7. Compliance Notes"),
